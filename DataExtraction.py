...
class DataExtraction(object):
    ...
    def __init__(self, plays_database):
        ...
        conn_game1 = sqlite3.connect("2017091003.db")

        self.game1 = pd.read_sql_query("SELECT * FROM '2017091003'", conn_game1)
        self.gameId = '2017091003'
